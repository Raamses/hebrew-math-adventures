...
// ⚡ Bolt: Wrapped FrenzyOverlay in React.memo to prevent unnecessary reconciliations
// during high-frequency game loops (like requestAnimationFrame) when overlay state is unchanged.
