...
- Name: profile-creation-smoke.spec.ts >> Profile creation + saga map landing >> creating a new profile persists it and lands on the saga map
- Location: e2e/profile-creation-smoke.spec.ts:33:3
