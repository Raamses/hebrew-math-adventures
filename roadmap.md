...
- [x] **Wrong Answer:**
  ...
  - Soft red glow/pulse.
  - Encouraging text ("בוא ננסה שוב" instead of "!נסה שוב").
- [ ] **Streak Milestones:**
  - Big, screen-filling animation for every 5/10 streak.

### 📦 PR 2: Session Progress & Micro-Goals
**Focus:** Give a sense of completion beyond endless play.
- [ ] **Session Logic:** Define a "Session" as 10 problems.
- [ ] **UI Component:** Add a `SessionProgressBar` (distinct from XP bar) at the top.
- [ ] **Completion Screen:**
  - When bar fills, show a "Session Complete!" summary modal.
  - Display stats: Accuracy, Time, XP earned.
  - "Play Again" or "Return to Map" buttons.

### 📦 PR 3: Sound Effects System (Audio Feedback)
**Focus:** Multi-sensory reinforcement.
- [ ] **Sound Manager:** Create a simple `SoundContext` or hook.
- [ ] **Assets:** Add kid-friendly sounds for:
